...
-- TRIGGERS
-- Trigger (X out of N) zistujuci či datum expiracie lieku nie je uz v minulosti
...
--PROCEDURES--
--procedura pocitajuca kolko percent zaberaju lieky zo skladu "sklad_id_arg"
-- z celkoveho poctu liekov vo vsetkych skladoch
-- v pripade ze nie je ziaden liek na sklade vypise chybu
...
BEGIN
    ...
    DECLARE CURSOR cursor_lieky is
        ...
        FROM POCET_LIEKOV_NA_SKLADE A;
            ...
            percenta_liekov NUMBER;
                BEGIN
                    pocet_vsetkych_liekov := 0;
                    lieky_sklad := 0;
                    OPEN cursor_lieky;
                    LOOP
                    FETCH cursor_lieky INTO id_sklad, id_liek;
                    ...
                    DBMS_OUTPUT.put_line('SKLAD s ID ' || sklad_id_arg || ' skladuje : ' || percenta_liekov || '% všetkých liekov na všetkých skladoch');
