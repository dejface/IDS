...
INSERT INTO SUCAST_NAKUPU(NAKUP_ID) VALUES(1);
INSERT INTO SUCAST_NAKUPU(NAKUP_ID) VALUES(2);
INSERT INTO SUCAST_NAKUPU(NAKUP_ID) VALUES(3);

INSERT INTO LIEK(CENA, DENNA_DAVKA, UCINNA_LATKA, EXPIRACIA, VEDLAJSIE_UCINKY) VALUES ('2,99','1 šumivá tableta denne','horčík a vitamín B6',TO_DATE('20.03.2021','dd.mm.yyyy'),'laxatívne účinky');
INSERT INTO LIEK(CENA, DENNA_DAVKA, UCINNA_LATKA, EXPIRACIA, VEDLAJSIE_UCINKY) VALUES ('99,89','3-krát 5 až 3-krát 10 tabliet denne','pankreatín, amyláza, lipáza, bromelaín, trypsín, papaín, chymotrypsín, rutozid trihydrát',TO_DATE('03.08.2021','dd.mm.yyyy'),'nevýrazná zmena konzistencie, farby a zápachu stolice, pocit plnosti');
INSERT INTO LIEK(CENA, DENNA_DAVKA, UCINNA_LATKA, EXPIRACIA, VEDLAJSIE_UCINKY) VALUES ('3,69','1 vstrek do každej nosovej dierky maximálne 3x denne','xylometazolíniumchlorid',TO_DATE('09.12.2020','dd.mm.yyyy'),'bolesti hlavy,nevoľnosť,krvácanie z nosa,zvýšený krvný tlak');
...
INSERT INTO HRADI_DOPLATOK(VYSKA_DOPLATKU, POISTOVNA) VALUES(10.06,1);
INSERT INTO HRADI_DOPLATOK(VYSKA_DOPLATKU, POISTOVNA) VALUES(0.53,1);
INSERT INTO HRADI_DOPLATOK(VYSKA_DOPLATKU, POISTOVNA) VALUES(1.22,1);
