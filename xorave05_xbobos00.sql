...
SELECT * FROM LEKAREN;
SELECT * FROM JE_V_ZMLUVE;
SELECT * FROM NAKUP;
SELECT * FROM SUCAST_NAKUPU;
SELECT * FROM LIEK;
SELECT * FROM BEZ_PREDPISU;
SELECT * FROM NA_PREDPIS;
SELECT * FROM HRADI_DOPLATOK;
SELECT * FROM SKLAD;
SELECT * FROM POCET_LIEKOV_NA_SKLADE;
SELECT * FROM ZDRAVOTNA_POISTOVNA;
SELECT * FROM VYKAZ;
SELECT * FROM AKTUALIZUJE;
